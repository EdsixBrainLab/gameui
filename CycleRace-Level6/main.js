...
var startBtn, introScrn, container, question, quesMarkMc, questionText,targetMc, resultLoading, preloadMc, background2, chHolderMc;
...
var chPosArr2 = [8, 1, 2, 3, 4, 5, 6, 7]  // IF Cycle Count reduces the array values should be reduced//
var chPosArr3 = [8, 1, 2, 3, 4, 5, 6, 7]

var self = this


var posY = [, 420, 440, 460, 480, 500, 530, 545, 565]// Cycle Y Position
var s1 = "";
...
function init() {
	...
	assetsPath = "assets/";
	gameAssetsPath = "CycleRace-Level6/";
	soundpath = "FA/"
	...
	if (success == 1) {
		manifest.push(
			...
			{ id: "questiontext", src: questionTextPath + "CycleRace-Level6-QT1.png" },
			...
			{ id: "question2", src: questionTextPath + "CycleRace-Level6-QT2.png" },
			{ id: "choice1", src: questionTextPath + "CycleRace-Level6-QT3.png" },
			{ id: "introHintTextMc", src: questionTextPath + "CycleRace-Level6-QT4.png" }
		)
		preloadAllAssets()
		stage.update();
	}
...
function pickques() {
	...
	speed_arry_1 = [1.8, 1.6, 1.4, 1.2, 1.0, 0.8, 0.5, 0.3];

	speed_arry = [1.8, 1.6, 1.0, 0.3, 1.2, 1.4, 0.5, 0.8];
...
function StopCycles() {
	...
	if (chPosArr1[cnt] == 0) {
		...
		// [1.8, 1.6, 1.4, 1.2, 1.0, 0.8, 0.5, 0.3];
		if (speed == 1.8) {
			chVal = 0
		} else if (speed == 1.6) {
			chVal = 1
