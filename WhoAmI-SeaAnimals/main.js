...
var words_arry = ["tortoise", "starfish", "crab", "whale", "lobster", "octopus", "dolphin", "jellyfish", "fish", "snail"];
var maxLetterCnt = 10
var quesArr = []
...
function init() {
    ...
    assetsPath = "assets/";
    gameAssetsPath = "WhoAmI-SeaAnimals/";
    soundpath = "FA/"
...
function doneLoading1(event) {
    ...
    stage.update();
	call_UI_gameQuestion(container,"Click on the correct letter to complete the name of the sea animal");
    if (id == "question") {
        var choiceSpriteSheet = new createjs.SpriteSheet({
            framerate: 30,
            "images": [preload.getResult("question")],
            "frames": { "regX": 50, "height": 287, "count": 64, "regY": 50, "width": 288 },
...
function createTween() {
  ...
  .call(() => { 
    ...
    for (i = 0; i < 3; i++) {
        ...
        choiceArr[i].alpha = 0;
        if (i == 2) {
            createjs.Tween.get(choiceArr[i]).wait(val).to({ y: 620, rotation: 180, scaleX: .65, scaleY: .65, alpha: .5 }, 100)
