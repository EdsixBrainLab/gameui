...
var startBtn, introScrn, container, choice1, choice2, choice3, choice4, question, circleOutline, circle1Outline, boardMc, helpMc, introClueText,quesMarkMc, questionText, quesHolderMc, resultLoading, preloadMc;
...
var quesArr = ["abacus", "absent", "absorb", "afford", "affect", "assume", "barber", "basket", "battle", "beaten", "behalf", "belief", "chance", "change", "choice",
    "commit", "decode", "detect", "defect", "donate", "equate", "esteem", "except", "expert", "finish", "forbid", "gossip", "impact", "impose", "injury",
    "invest", "linear", "medium", "mockup", "mutual", "motive", "native", "notice", "orator", "outfit", "orient", "plural", "pledge", "prefix", "pretty",
    "refuse", "scarse", "supply", "thrive", "uplift"];
...
function init() {
    ...
    assetsPath = "assets/";
    gameAssetsPath = "MissingLetter-Level2/";
    soundpath = "FA/"
    ...
    if (success == 1) {
        manifest.push(
            ...
            { id: "QusTxtString", src: questionTextPath + "MissingLetter-Level2-QT.png" }
...
function CreateGameElements() {
    ...
    container.parent.addChild(cluetext);
    cluetext.visible = false;
    cluetext.x = 460; cluetext.y = 440;
    cluetext.scaleX = cluetext.scaleY = 1.4

    for (i = 0; i < 6; i++) {
        qarr[i] = quekey.clone();
        container.parent.addChild(qarr[i])
        //qarr[i].scaleX = qarr[i].scaleY = .9
        qarr[i].x = 225 + (i * 155)//btn1[i];
        qarr[i].y = 250;
    }
...
function createTween() {
    ...
    cluetext.alpha = 0
    createjs.Tween.get(cluetext).wait(700).to({ y: 440, scaleX: .95, scaleY: .95, alpha: 1 }, 500)
    ///////////////////////////choice tween////////////////////////////////////
    for (i = 0; i < 5; i++) {
