...
var words_arry = ["baker", "farmer", "teacher", "dealer", "airmen", "builder", "salesmen", "nurse",
    "actors", "artist", "educator", "porter", "soldier", "umpire", "warden", "trader",
    "rider", "singer", "priest", "painter", "maid", "cobbler", "deans", "mason"]

var nameArr = ["break", "framer", "cheater", "leader", "marine", "rebuild", "nameless", "runes",
    "costar", "traits", "outraced", "report", "solider", "impure", "warned", "retard",
    "drier", "resign", "stripe", "repaint", "amid", "clobber", "sedan", "moans"]
...
loaderBar.visible = false;
  stage.update();
   ...
   call_UI_gameQuestion(container,"Find the name of a job that is an anagram of");
