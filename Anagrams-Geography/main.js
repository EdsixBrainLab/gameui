...
var words_arry = ["dam", "east", "field", "delta", "stream", "lakes", "forest", "north", "dune", "deserts", "south", "soil", "slope", "shore", "terrace", "peaks",
    "plains", "pole", "region", "rock"]
var nameArr = ["mad", "sate", "filed", "dealt", "master", "leaks", "foster", "thorn", "nude", "dessert", "shout", "oils", "poles", "horse", "retrace", "speak",
    "spinal", "lope", "ignore", "cork"]
...
function init() {
  ...
  assetsPath = "assets/";
  gameAssetsPath = "Anagrams-Geography/";
  soundpath = "FA/";
...
loaderBar.visible = false;
  stage.update();
   ...
   call_UI_gameQuestion(container,"Find a term related to geography that is an anagram of");
