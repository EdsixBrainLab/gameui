...
var objArr3 = [{ x: 723.3 - 60, y: 122.7 }, { x: 899.3 - 60, y: 233.7 }, { x: 990.3 - 60, y: 380.6 }]

//var objArr4 = [{ x: 271.2 - 300, y: 243.4 }, { x: 119.2 - 300, y:362.4 }, { x: 145.5 - 300, y: 458.6 }]

//--------------------------------------------------QuestionSet------------------------------------------------------//
var questionArr0 = [0, 1, 2]
var questionArr1 = [3, 4, 5]
var questionArr2 = [6, 7, 8]
var questionArr3 = [9, 10, 11]
var questionArr4 = [12, 13, 14]
var questionArr5 = [2, 4, 6]
var questionArr6 = [5, 7, 9]
var questionArr7 = [8, 10, 12]
var questionArr8 = [11, 13, 0]
var questionArr9 = [14, 1, 3]
var questionArr10 = [0, 2, 4]
var questionArr11 = [1, 3, 5]
var questionArr12 = [6, 8, 10]
var questionArr13 = [7, 9, 11]
var questionArr14 = [12, 13, 14]

//---------------------------------------------------------------------------------------------------------------------//
var answerArr0 = [3, 1, 2]
var answerArr1 = [6, 4, 5]
var answerArr2 = [9, 7, 8]
var answerArr3 = [12, 10, 11]
var answerArr4 = [0, 13, 14]
var answerArr5 = [5, 2, 4]
var answerArr6 = [8, 5, 7]
var answerArr7 = [11, 8, 10]
var answerArr8 = [14, 11, 13]
var answerArr9 = [2, 14, 1]
var answerArr10 = [1, 0, 4]
var answerArr11 = [6, 1, 5]
var answerArr12 = [7, 6, 10]
var answerArr13 = [12, 7, 11]
var answerArr14 = [4, 12, 14]
var btnX = []
//------------------------------------------------------------------------------------------------------------------//
...
function init() {
    ...
    assetsPath = "assets/";
    gameAssetsPath = "BalloonBurst-A2/";
    soundpath = "FA/"
    ...
    if (success == 1) {
        manifest.push(
            ...
            { id: "questiontext1", src: questionTextPath + "BalloonBurst-A2-QT1.png" },
            { id: "questionText", src: questionTextPath + "BalloonBurst-A2-QT.png" },
...
function CreateGameElements() {
    ...
    balloonMc.x = 570;
    questiontext1.visible = false
    questiontext1.x = questiontext1.x - 20;
    container.parent.addChild(questiontext1);
    questionText.visible = false;
    container.parent.addChild(questionText);
    if (lang == "HindiQuestionText/") {
        ...
        questionText.x = 260; questionText.y = 130;
    }

    questionText.scaleX = questionText.scaleY = 1.1;
    ...
    choiceArr[0].x = 265; choiceArr[0].y = 350;
    choiceArr[1].x = 580; choiceArr[1].y = 350;
    choiceArr[2].x = 905; choiceArr[2].y = 350;
...
function pickques() {
    ...
    console.log("getFinalObjArr==" + getFinalObjArr)
    ...
    for (i = 0; i < 3; i++) {
        ...
        tweenMcArr[i].timeline.addTween(
            createjs.Tween.get(quesArr[i])
                .to({ x: 550, y: 50 }, 9).to({ x: this["objArr" + i][0].x + 560, y: this["objArr" + i][0].y + 30 },
                    timeFrameSpeed).to({ x: this["objArr" + i][1].x + 370, y: this["objArr" + i][1].y + 30 },
                        timeFrameSpeed).to({ x: this["objArr" + i][2].x + 480, y: this["objArr" + i][2].y + 30 },
                            timeFrameSpeed));
