...
var introQuestxtX = 250, introQuestxtY = 130;
...
var introArrowX = 610, introArrowY = 280;
var introfingureX = 650, introfingureY = 470;
...
function commongameintro() {
    ...
    if (lang == "HindiQuestionText/") {
        introQuestxt1.x = introQuestxtX + 100;
    ...
    introQuestxt1.gotoAndStop(1);
    introQuestxt.x = introQuestxt.x - 20;
...
function introCh() {
    if (stopValue == 0) {
        ...
        for (i = 0; i < 3; i++) {
            ...
            introquesArr[i].x = 50 + (i * 50)
            introquesArr[i].y = 150;
            introTween[i].timeline.addTween(
                createjs.Tween.get(introquesArr[i])
                    .to({ x: 550, y: 50 }, 9).to({ x: this["objArr" + i][0].x + 500, y: this["objArr" + i][0].y + 40 },
                        timeFrameSpeed).to({ x: this["objArr" + i][1].x + 460, y: this["objArr" + i][1].y + 40 },
                            timeFrameSpeed).to({ x: this["objArr" + i][2].x + 470, y: this["objArr" + i][2].y + 40 },
                                timeFrameSpeed));
