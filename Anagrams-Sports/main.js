...
var nameArr = ["tab", "blowing", "filed", "this", "sinning",
    "lamed", "cores", "meat", "retrain", "replay",
    "own", "impure", "worth", "sooth", "steaks",
    "urn", "pinto", "ten", "flog", "sole"];
var words_arry = ["bat", "bowling", "field", "hits", "innings",
    "medal", "score", "team", "trainer", "player",
    "won", "umpire", "throw", "shoot", "skates",
    "run", "point", "net", "golf", "lose"];
...
function init() {
  ...
  assetsPath = "assets/";
  gameAssetsPath = "Anagrams-Sports/";
  soundpath = "FA/";
...
loaderBar.visible = false;
  stage.update();
   ...
   call_UI_gameQuestion(container,"Find the word related to sports that is an anagram of");
