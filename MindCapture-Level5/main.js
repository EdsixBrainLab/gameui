...
var btnx = [, 205, 635, 1045, 205, 655, 1065]
...
function init() {
    ...
    assetsPath = "assets/";
    gameAssetsPath = "MindCapture-Level5/";
    soundpath = "FA/"
    ...
    if (success == 1) {
        manifest.push(
            ...
            { id: "no", src: questionTextPath + "MindCapture-Level5-QT1.png" },
            { id: "yes", src: questionTextPath + "MindCapture-Level5-QT2.png" }
        )
        preloadAllAssets()
        stage.update();
    }
...
function CreateGameElements() {
    ...
    if (QusTxtString) {
        ...
        if (typeof SAUIX_setQuestionText !== "function") {
            QusTxtString.scaleX = QusTxtString.scaleY = 1;
            if (lang == "TamilQuestionText/") {
                QusTxtString.x = 340; QusTxtString.y = 130;
                QusTxtString.scaleX = 1.2;
                QusTxtString.scaleY = 1.2;
            } else if (lang == "ArabicQuestionText/") {
                QusTxtString.scaleX = 1.2;
                QusTxtString.scaleY = 1.7;
                QusTxtString.x = 318;
                QusTxtString.y = 130;
            }
            else {
                QusTxtString.scaleX = QusTxtString.scaleY = 1;
                QusTxtString.x = 310; QusTxtString.y = 130;
            }
        }
    }
    ...
    qhHolder.visible = false;
    container.parent.addChild(qhHolder)
    qhHolder.y = qhHolder.y + 20
    container.parent.addChild(choice1);
    choice1.visible = false;

    btnx = [, 195, 615, 1033, 195, 615, 1033]
...
function createChoices() {
    ...
    choice1.scaleX = choice1.scaleY = .65
...
function createTween1() {
    ...
    if (posChangeArr[cnt] == 0) {
        choice1.y = -300
        if (qch1[1] > 3) {
            createjs.Tween.get(choice1).wait(1000).to({ alpha: 1, x: choice1.x, y: 410 }, 600, createjs.Ease.bounceOut);
        } else {
            createjs.Tween.get(choice1).wait(1000).to({ alpha: 1, x: choice1.x, y: 180 }, 600, createjs.Ease.bounceOut);
        }
    } else {
        choice1.y = 900
        if (qch1[1] > 3) {
