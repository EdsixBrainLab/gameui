...
var introChoiceX = [, 290, 880]
var introChoiceY = 240
var introArrowX = 700, introArrowY = 500;
var introfingureX = 730, introfingureY = 590;
var introquestionX = 890; introquestionY = -240;
var introquestionTextX = 310; introquestionTextY = 130
var introyesx = 700, introyesy = 630;
var intronox = 980; intronoy = 630;
...
function commongameintro() {
    ...
    for (i = 1; i <= 2; i++) {
        ...
        introquesArr[i].gotoAndStop(7 + i);
        introquesArr[i].scaleX = introquesArr[i].scaleY = 1.3
    }
...
function quesTween() {
    ...
    for (i = 1; i <= 2; i++) {
        ...
        if (i == 2) {
            createjs.Tween.get(introquesArr[i]).wait(1000).to({ alpha: 1, x: introChoiceX[i] }, introtempVal, createjs.Ease.bounceOut).wait(2000).call(handleComplete2_1);
        } else {
...
function choiceTween() {
    var introvalX = [, 430, 720]
    // var introvalY=[,380,700]
    for (i = 1; i <= 2; i++) {
        createjs.Tween.get(introquesArr[i]).wait(50).to({ x: introvalX[i], scaleX: 1, scaleY: 1 }, 500).to({ alpha: 1 })
    }
