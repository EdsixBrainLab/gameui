...
var introQuesTextX =10, introQuesTextY = -10;
var introQuesX = 600, introQuesY =235
var introArrowX = 450, introArrowY = 505;
var introfingureX = 460, introfingureY = 600;
...
function QueschoiceTween() { 
 ...
 for (i = 0; i <4; i++) {
        ...
        introChoiceQues[1].gotoAndStop(4);
        introChoiceQues[2].gotoAndStop(0);
...
var val =500
  for (i = 0; i < 3; i++) {
        ...
        introchoiceArr[0].gotoAndStop(17);
...
this.onComplete2 = function (e) {
    ...
    if (stopValue == 0) {
        ...
        introChoiceQues[3].gotoAndStop(17);     
