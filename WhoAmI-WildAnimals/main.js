...
var words_arry = ["bear", "monkey", "zebra", "giraffe", "lion", "deer", "tiger", "kangaroo", "fox", "elephant",
"porcupine","rhinoceros","koala","hyena","horse","meerkat","wolf","panda","gorilla","cheetah"];
...
function init() {
    ...
    assetsPath = "assets/";
    gameAssetsPath = "WhoAmI-WildAnimals/";
    soundpath = "FA/"
...
function doneLoading1(event) {
    ...
    stage.update();
	call_UI_gameQuestion(container,"Click on the correct letter to complete the name of the wild animal");
    if (id == "question") {
