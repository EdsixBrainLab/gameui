...
var introQuesX = 600, introQuesY =215
var introArrowX = 450, introArrowY = 493;
var introfingureX = 505, introfingureY = 575;
...
//////////////////////////////////////////////////////////////////////////
    ...
    for (i = 0; i < 4; i++) {
        ...
        introChoiceQues[i].x =410 + (i * 150);
        introChoiceQues[i].y = 440;
...
function QueschoiceTween() { 
 ...
 for (i = 0; i <4; i++) {
        ...
        introChoiceQues[0].gotoAndStop(17);
        introChoiceQues[1].gotoAndStop(14);
        introChoiceQues[2].gotoAndStop(18);
...
var val =500
  for (i = 0; i < 3; i++) {
        ...
        if(i==2)
{
         createjs.Tween.get(introchoiceArr[i]).wait(val).to({ y: 589,rotation:180, scaleX: .65, scaleY: .65, alpha: .5 }, 200)
        .to({ y: 589,rotation:360, scaleX: .7, scaleY: .7, alpha: 1 }, 200)
