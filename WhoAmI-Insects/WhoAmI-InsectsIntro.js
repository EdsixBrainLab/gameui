...
var introQuesX = 580, introQuesY =220
var introArrowX = 447, introArrowY = 510;
var introfingureX = 468, introfingureY = 580;
...
//////////////////////////////////////////////////////////////////////////
    ...
    for (i = 0; i < 3; i++) {
        ...
        introChoiceQues[i].x =480 + (i * 150);
        introChoiceQues[i].y = 450;
...
function QueschoiceTween() { 
 ...
 for (i = 0; i <3; i++) {
        ...
        introChoiceQues[0].gotoAndStop(5);
...
var val =500
  for (i = 0; i < 3; i++) {
        ...
        introchoiceArr[i].gotoAndStop(i+15);
        introchoiceArr[0].gotoAndStop(24);
...
this.onComplete2 = function (e) {
    ...
    if (stopValue == 0) {
        ...
        introChoiceQues[2].gotoAndStop(24);     
