...
var words_arry = ["fly", "bug", "bee", "ant", "dragonfly", "grasshopper", "mosquito", "cockroach", "butterfly", "spider"];
var maxLetterCnt = 10
var quesArr = []
...
function doneLoading1(event) {
    ...
    stage.update();
	call_UI_gameQuestion(container,"Click on the correct letter to complete the name of the insect");
    if (id == "question") {
        var choiceSpriteSheet = new createjs.SpriteSheet({
            framerate: 30,
            "images": [preload.getResult("question")],
            "frames": { "regX": 50, "height": 355, "count": 64, "regY": 50, "width": 354 },
    ...
    if (id == "question1") {
        var choiceSpriteSheet = new createjs.SpriteSheet({
            ...
            "frames": { "regX": 50, "height": 116, "count": 64, "regY": 50, "width": 113 },
            // define two animations, run (loops, 1.5x speed) and jump (returns to run):
        });
