...
var introChoiceX = [, 175, 460, 760, 1040, 325, 605, 890]//[, 225, 645, 1063,  225, 645, 1063]
var introArrowX = 660, introArrowY = 540;
var introfingureX = 690, introfingureY = 620;
var introquestionX = 610; introquestionY = -240;
var introquestionTextX = 310, introquestionTextY = 130
// var introquestionTextX = 353, introquestionTextY = 135///GUJARATI
var introyesx = 660, introyesy = 670;
var intronox = 940; intronoy = 670;
...
function commongameintro() {
    ...
    if (lang == "TamilQuestionText/") {
        ...
        introquestionText.scaleX = introquestionText.scaleY = 1.2;
        introquestionText.x = 363;
        introquestionText.y = 130;
    }
    else {
    ...
    for (i = 1; i <= 7; i++) {
        ...
        if (i <= 4) {
            introquesArr[i].y = 213
            // introquesArr[i].gotoAndStop(5 + i);
        }
        else {
            introquesArr[i].y = 453
        }
...
function choiceTween() {
    var introvalX = [, 430, 500, 580, 650, 720, 800, 470]
...
function choiceTween1() {
    ...
    createjs.Tween.get(introHintImg).wait(3000).to({ scaleX: .5, scaleY: .5, x: 50, y: 220 }, 500).wait(500).call(handleComplete4_1);
