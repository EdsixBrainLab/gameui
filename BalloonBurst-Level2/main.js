...
var currentX, currentY, questiontext1
...
function init() {
    ...
    if (success == 1) {
        manifest.push(
            ...
            { id: "questiontext1", src: questionTextPath + "BalloonBurst-Level2-QT1.png" },
            { id: "questionText", src: questionTextPath + "BalloonBurst-Level2-QT.png" },
