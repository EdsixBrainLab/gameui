...
function CreateTween() {
    ...
    createjs.Tween.get(question).wait(3000).to({ x: questionAnchor.x, y: questionAnchor.y, alpha: 1 }, 500).to({ y: questionAnchor.y + 73 }, 1000, createjs.Ease.bounceOut).wait(500).call(changechoice1);
...
function changechoice1() {
    // cappos = 0;
    question.visible = false;
    var swapTarget0 = getScaledPosition(quesArr[qnoI[0]], sX[qnoI[3]], sY[qnoI[3]]);
    createjs.Tween.get(quesArr[qnoI[0]]).to({ x: swapTarget0.x, y: swapTarget0.y }, 400).wait(500);
    var swapTarget1 = getScaledPosition(quesArr[qnoI[1]], sX[qnoI[0]], sY[qnoI[0]]);
    createjs.Tween.get(quesArr[qnoI[1]]).to({ x: swapTarget1.x, y: swapTarget1.y }, 400).wait(500);
    var swapTarget2 = getScaledPosition(quesArr[qnoI[2]], sX[qnoI[4]], sY[qnoI[4]]);
    createjs.Tween.get(quesArr[qnoI[2]]).to({ x: swapTarget2.x, y: swapTarget2.y }, 300).wait(400);
    var swapTarget3 = getScaledPosition(quesArr[qnoI[3]], sX[qnoI[1]], sY[qnoI[1]]);
    createjs.Tween.get(quesArr[qnoI[3]]).to({ x: swapTarget3.x, y: swapTarget3.y }, 300).wait(400);
    var swapTarget4 = getScaledPosition(quesArr[qnoI[4]], sX[qnoI[2]], sY[qnoI[2]]);
    createjs.Tween.get(quesArr[qnoI[4]]).to({ x: swapTarget4.x, y: swapTarget4.y }, 300).wait(400).call(changeoption11);

}
function changeoption11() {
    var cycleTarget0 = getScaledPosition(quesArr[qnoI[0]], sX[qnoI[2]], sY[qnoI[2]]);
    createjs.Tween.get(quesArr[qnoI[0]]).to({ x: cycleTarget0.x, y: cycleTarget0.y }, 400).wait(500);
    var cycleTargetMid = getScaledPosition(quesArr[qnoI[1]], sX[qnoI[1]], sY[qnoI[1]]);
    createjs.Tween.get(quesArr[qnoI[1]]).to({ x: cycleTargetMid.x, y: cycleTargetMid.y }, 400).wait(500);
    var cycleTargetPrev = getScaledPosition(quesArr[qnoI[3]], sX[qnoI[0]], sY[qnoI[0]]);
    createjs.Tween.get(quesArr[qnoI[3]]).to({ x: cycleTargetPrev.x, y: cycleTargetPrev.y }, 400).wait(500);
    if (choiceChange[cnt] == 0) {
        var stayTarget = getScaledPosition(quesArr[qnoI[4]], sX[qnoI[3]], sY[qnoI[3]]);
        createjs.Tween.get(quesArr[qnoI[4]]).to({ x: stayTarget.x, y: stayTarget.y }, 400).wait(500).call(changeoption12);
    } else {
        var stayTargetImmediate = getScaledPosition(quesArr[qnoI[4]], sX[qnoI[3]], sY[qnoI[3]]);
        createjs.Tween.get(quesArr[qnoI[4]]).to({ x: stayTargetImmediate.x, y: stayTargetImmediate.y }, 400).wait(500).call(AddListenerFn);
        ans = qnoI[2]
    }
}
function changeoption12() {
    if (choiceChange[cnt] == 0) {
        var cycleTargetA = getScaledPosition(quesArr[qnoI[0]], sX[qnoI[1]], sY[qnoI[1]]);
        ...
        var cycleTargetD = getScaledPosition(quesArr[qnoI[3]], sX[qnoI[4]], sY[qnoI[4]]);
        createjs.Tween.get(quesArr[qnoI[3]]).to({ x: cycleTargetD.x, y: cycleTargetD.y }, 600).wait(700);
        var cycleTargetE = getScaledPosition(quesArr[qnoI[4]], sX[qnoI[2]], sY[qnoI[2]]);
        createjs.Tween.get(quesArr[qnoI[4]]).to({ x: cycleTargetE.x, y: cycleTargetE.y }, 600).wait(700).call(AddListenerFn);
        ans = qnoI[1]
    }
}
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
