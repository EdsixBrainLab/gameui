...
var nameArr = ["god", "act", "bare", "flow", "balm", "star", "pea", "seashore", "loin", "hear", "shore", "sale"];
var words_arry = ["dog", "cat", "bear", "wolf", "lamb", "rats", "ape", "seahorse", "lion", "hare", "horse", "seal"];
...
function init() {
  ...
  assetsPath = "assets/";
  gameAssetsPath = "Anagrams-Animals/";
  soundpath = "FA/";
...
loaderBar.visible = false;
  stage.update();
   ...
   call_UI_gameQuestion(container,"Find the name of an animal that is an anagram of");
