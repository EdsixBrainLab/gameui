...
var nameArr = ["boast", "scab", "sub", "arc", "jest",
    "hips", "struck", "mart", "panel", "boathouse",
    "curries", "restock"];
var words_arry = ["boats", "cabs", "bus", "car", "jets",
    "ship", "trucks", "tram", "plane", "houseboat",
    "cruiser", "rockets"];
...
function init() {
  ...
  assetsPath = "assets/";
  gameAssetsPath = "Anagrams-Vehicles/";
  soundpath = "FA/";
...
loaderBar.visible = false;
  stage.update();
   ...
   call_UI_gameQuestion(container,"Find the name of a vehicle that is an anagram of");
