...
var introChoiceRevealOrder = [null, 2, 3, 4, 1]
...
function commongameintro() {
    ...
    var choiceConfigs = [
        { index: 1, x: introChoice1X, y: introChoice1Y, letter: "W" },
        { index: 2, x: introChoice2X, y: introChoice2Y, letter: "D" },
        { index: 3, x: introChoice3X, y: introChoice3Y, letter: "R" },
        { index: 4, x: introChoice4X, y: introChoice4Y, letter: "A" }
    ];
