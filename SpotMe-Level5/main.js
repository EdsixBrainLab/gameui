...
function init() {
    ...
    if (success == 1) {
        manifest.push(
            ...
            { id: "questionText", src:questionTextPath + "SpotMe-Level5-QT.png" }
...
function CreateTween() {
    ...
    question.alpha = 0
    createjs.Tween.get(question).wait(3000).to({ y: sY1[qnoI[0]], alpha: 1 }, 500).to({ y: sY1[qnoI[0]] + 70 }, 1000, createjs.Ease.bounceOut).wait(500).call(changechoice1);
...
function changechoice1() {
    question.visible = false
    createjs.Tween.get(quesArr[qnoI[0]]).to({ x: sX[qnoI[5]], y: sY[qnoI[5]] }, 400).wait(500);
    ...
    createjs.Tween.get(quesArr[qnoI[3]]).to({ x: sX[qnoI[4]], y: sY[qnoI[4]] }, 300).wait(400);
    createjs.Tween.get(quesArr[qnoI[4]]).to({ x: sX[qnoI[1]], y: sY[qnoI[1]] }, 300).wait(400);
    createjs.Tween.get(quesArr[qnoI[5]]).to({ x: sX[qnoI[0]], y: sY[qnoI[0]] }, 300).wait(400).call(changeoption11);
}
function changeoption11() {
    createjs.Tween.get(quesArr[qnoI[0]]).to({ x: sX[qnoI[3]], y: sY[qnoI[3]] }, 400).wait(500);
    if (choiceChange[cnt] == 0) {
        createjs.Tween.get(quesArr[qnoI[1]]).to({ x: sX[qnoI[5]], y: sY[qnoI[5]] }, 400).wait(500).call(changeoption12);
    } else {
        createjs.Tween.get(quesArr[qnoI[1]]).to({ x: sX[qnoI[5]], y: sY[qnoI[5]] }, 400).wait(500).call(AddListenerFn);
    }
    ans = qnoI[3]
}
function changeoption12() {
    createjs.Tween.get(quesArr[qnoI[0]]).to({ x: sX[qnoI[2]], y: sY[qnoI[2]] }, 600).wait(700);
    createjs.Tween.get(quesArr[qnoI[1]]).to({ x: sX[qnoI[4]], y: sY[qnoI[4]] }, 600).wait(700);
    createjs.Tween.get(quesArr[qnoI[2]]).to({ x: sX[qnoI[1]], y: sY[qnoI[1]] }, 600).wait(700);
    createjs.Tween.get(quesArr[qnoI[3]]).to({ x: sX[qnoI[3]], y: sY[qnoI[3]] }, 600).wait(700);
    createjs.Tween.get(quesArr[qnoI[4]]).to({ x: sX[qnoI[0]], y: sY[qnoI[0]] }, 600).wait(700);
    createjs.Tween.get(quesArr[qnoI[5]]).to({ x: sX[qnoI[5]], y: sY[qnoI[5]] }, 600).wait(700).call(AddListenerFn);
    ans = qnoI[2]
}
