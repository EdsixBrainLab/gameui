...
var SPOTME_BOARD_BASE_POS = { x: 0, y: 22 };
...
var sX = [483, 680, 771, 691, 473, 370];
var sY = [200, 200, 410, 600, 600, 410];
var sX1 = [555, 752, 841, 761, 545, 440];
var sY1 = [160, 160, 364, 560, 560, 370];
var choiceChange = []
var dummyArr = []
var basketHotspots = [];
var spriteChange = []
...
var shuffleArr2 = []
var shuffleArr3 = []
var btnx = [453, 881, 961, 881, 453, 353]
var btny = [255, 255, 430, 620, 620, 430]
var btnx2 = [453, 781, 861, 881, 453, 453]
var btny2 = [355, 255, 430, 520, 520, 430]
...
function changechoice1() {
    question.visible = false;
    var swapTarget0 = getScaledPosition(quesArr[qnoI[0]], sX[qnoI[5]], sY[qnoI[5]]);
    ...
    var swapTarget3 = getScaledPosition(quesArr[qnoI[3]], sX[qnoI[4]], sY[qnoI[4]]);
    ...
    var swapTarget5 = getScaledPosition(quesArr[qnoI[5]], sX[qnoI[0]], sY[qnoI[0]]);
    createjs.Tween.get(quesArr[qnoI[5]]).to({ x: swapTarget5.x, y: swapTarget5.y }, 300).wait(400).call(changeoption11);
}
function changeoption11() {
    ...
    if (choiceChange[cnt] == 0) {
        var cycleTarget1 = getScaledPosition(quesArr[qnoI[1]], sX[qnoI[5]], sY[qnoI[5]]);
        createjs.Tween.get(quesArr[qnoI[1]]).to({ x: cycleTarget1.x, y: cycleTarget1.y }, 400).wait(500).call(changeoption12);
    } else {
        var cycleTargetImmediate = getScaledPosition(quesArr[qnoI[1]], sX[qnoI[5]], sY[qnoI[5]]);
...
function changeoption12() {
    var flowTarget0 = getScaledPosition(quesArr[qnoI[0]], sX[qnoI[2]], sY[qnoI[2]]);
    createjs.Tween.get(quesArr[qnoI[0]]).to({ x: flowTarget0.x, y: flowTarget0.y }, 600).wait(700);
    var flowTarget1 = getScaledPosition(quesArr[qnoI[1]], sX[qnoI[4]], sY[qnoI[4]]);
    ...
    var flowTarget3 = getScaledPosition(quesArr[qnoI[3]], sX[qnoI[3]], sY[qnoI[3]]);
    createjs.Tween.get(quesArr[qnoI[3]]).to({ x: flowTarget3.x, y: flowTarget3.y }, 600).wait(700);
    var flowTarget4 = getScaledPosition(quesArr[qnoI[4]], sX[qnoI[0]], sY[qnoI[0]]);
    createjs.Tween.get(quesArr[qnoI[4]]).to({ x: flowTarget4.x, y: flowTarget4.y }, 600).wait(700);
    var flowTarget5 = getScaledPosition(quesArr[qnoI[5]], sX[qnoI[5]], sY[qnoI[5]]);
    createjs.Tween.get(quesArr[qnoI[5]]).to({ x: flowTarget5.x, y: flowTarget5.y }, 600).wait(700).call(AddListenerFn);
    ans = qnoI[2]
}
