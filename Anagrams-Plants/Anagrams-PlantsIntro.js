...
console.log("canvas.width ::"+canvas.width)
    ...
    call_UI_introQuestionCardContainer(container,"hubs");
    ...
    introChoice4.gotoAndStop(20)
    cluegotoArr = [, 1, 20, 18, 7]
