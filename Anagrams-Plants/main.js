...
var nameArr = ["dub", "hubs", "danger", "nosed", "tuns",
    "soak", "sore", "plates", "reset", "oils",
    "brush", "stupor", "ropes", "vein", "sewed",
    "warts", "flea", "ape", "torso", "lapsing"];
var words_arry = ["bud", "bush", "garden", "nodes", "nuts",
    "oaks", "rose", "petals", "trees", "soil",
    "shrub", "sprout", "spore", "vine", "weeds",
    "straw", "leaf", "pea", "roots", "sapling"];
...
function init() {
  ...
  assetsPath = "assets/";
  gameAssetsPath = "Anagrams-Plants/";
  soundpath = "FA/";
...
loaderBar.visible = false;
  stage.update();
   ...
   call_UI_gameQuestion(container,"Find the word related to plants that is an anagram of");
