...
var introQuestxtX = 280, introQuestxtY = 130;
...
var introArrowX = 462, introArrowY = 290;
var introfingureX = 517, introfingureY = 490;
...
function commongameintro() {
    ...
    introQuestxt.x = introQuestxt.x - 50;
...
function introCh() {
    if (stopValue == 0) {
        ...
        for (i = 0; i < 4; i++) {
            ...
            introquesArr[i].x = 70 + (i * 70)
            introquesArr[i].y = 150;
            introTween[i].timeline.addTween(
                createjs.Tween.get(introquesArr[i])
                    .to({ x: 550, y: 50 }, 9).to({ x: this["objArr" + i][0].x + 320, y: this["objArr" + i][0].y + 170 }, timeFrameSpeed).to({ x: this["objArr" + i][1].x + 320, y: this["objArr" + i][1].y + 170 }, timeFrameSpeed).to({ x: this["objArr" + i][2].x + 320, y: this["objArr" + i][2].y + 170 }, timeFrameSpeed));
