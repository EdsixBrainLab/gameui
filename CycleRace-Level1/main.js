...
var startBtn, introScrn, container, question, helpMc, quesMarkMc, questionText, questionText1, resultLoading, preloadMc, background2, chHolderMc;
...
var qno1 = []
var qno = []
var chVal, speed, count, spliceVal, introImg
//////////////////////////////////////////////////////==========GAME SPECIFIC ARRAYS============/////////////////////////////////////////////////////////////
var choiceArr = []
var choiceArr1 = []
var chPosArr = [1, 0, 2, 0, 1, 0, 2, 1, 1, 2] // Only 4 Choice 
...
var chPosArr3 = [1, 2, 3, 1, 2, 3]
var self = this
var posY = [, 400, 420, 435, 463, 485, 513, 535, 558] // Cycle Y Position
var s1 = "";
...
function init() {
	...
	assetsPath = "assets/";
	gameAssetsPath = "CycleRace-Level1/";
	soundpath = "FA/"
	...
	if (success == 1) {
		manifest.push(
			...
			{ id: "questiontext", src:questionTextPath + "CycleRace-Level1-QT1.png" },
			...
			{ id: "question2", src: questionTextPath + "CycleRace-Level1-QT2.png" },
			{ id: "choice1", src:  questionTextPath + "CycleRace-Level1-QT3.png" },
			{ id: "choice2", src: gameAssetsPath + "ChoiceImages2.png" },
			{ id: "chHolder", src: gameAssetsPath + "chHolder.png" },
			{ id: "question2", src: questionTextPath + "CycleRace-Level1-QT2.png" },
			{ id: "choice1", src:  questionTextPath + "CycleRace-Level1-QT3.png" },
			{ id: "introHintTextMc", src: questionTextPath + "CycleRace-Level1-QT4.png" },
...
function doneLoading1(event) {
	...
	// if (isSafari == true) {
	// 	speed_arry = [5.0, 7.4, 9.0, 12.2, 18.2, 15.2];
	// 	speed = 20;
	// 	console.log("isSafari:= " + speed)

	// }
	// else if (isChrome || isIE || isBlink || isFirefox || isOpera || isEdge) {
	// 	speed_arry = [4.0, 5.4, 6.0, 8.8, 12.2, 10.4];
	// 	speed = 40;
	// 	console.log("isChrome:= " + speed)
	// }
	// if (isMobile.iOS() && !isChrome) {
	// 	speed_arry = [5.0, 7.4, 9.0, 12.2, 18.2, 15.2];
	// 	speed = 20;
	// 	console.log("iOS:= " + speed)
	// }
	// if (isMobile.iOS() && isChrome) {
	// 	speed_arry = [5.0, 7.4, 9.0, 12.2, 18.2, 15.2]
	// 	speed = 20;
	// 	console.log("iOS && isChrome:= " + speed)
	// }
	// if (isMobile.any()) {
	// 	speed_arry = [11.0, 13.4, 15.0, 18.2, 22.2, 20.2]
	// 	speed = 40;
	// 	console.log("android:= " + speed)
	// }
}
...
function CreateGameElements() {
	...
	var choiceXArr = [410, 780, 595]
	var choiceYArr = [310, 310, 430]
...
function pickques() {
	...
	speed_arry_1 = [2.6, 2.2, 1.6];


	speed_arry = [2.6, 2.2, 1.6];
...
function createQuestions() {
	...
	question2.x = 360; question2.y = 230;
...
function createTween() {
	if (chPosArr1[cnt] == 0) {
		...
		createjs.Tween.get(choiceArr1[0]).wait(200).to({ x: choiceArr1[0].x, y: 300, alpha: 0 }, 500).to({ x: choiceArr1[0].x, y: 320, alpha: 0.5 }, 500).to({ x: choiceArr1[0].x, y: 300, alpha: 1 })
		createjs.Tween.get(choiceArr1[1]).wait(300).to({ x: choiceArr1[1].x, y: 320, alpha: 0 }, 500).to({ x: choiceArr1[1].x, y: 300, alpha: 0.5 }, 500).to({ x: choiceArr1[1].x, y: 300, alpha: 1 })
		createjs.Tween.get(choiceArr1[2]).wait(600).to({ x: choiceArr1[2].x, y: 300, alpha: 0 }, 500).to({ x: choiceArr1[2].x, y: 320, alpha: 0.5 }, 500).to({ x: choiceArr1[2].x, y: 300, alpha: 1 })
...
function AddListenerFn() {
	...
	if (chPosArr1[cnt] == 0) {
		...
		for (i = 0; i < choiceCnt; i++) {
			...
			choiceArr1[i].addEventListener("mouseover", onRoll_over)
		}
	}
	rst = 0;
...
function disablechoices() {
	...
	for (i = 0; i < choiceCnt; i++) {
		...
		choiceArr[i].removeEventListener("mouseover", onRoll_out)
		choiceArr1[i].removeEventListener("mouseover", onRoll_out)
	}
