...
BASKETBALL_L2_PROMPTS[BASKETBALL_L2_PROMPT_INDEXES.OBSERVE] = "Observe the basketballs carefully.";
BASKETBALL_L2_PROMPTS[BASKETBALL_L2_PROMPT_INDEXES.COLOR_FIRST] = "Which color ball went into the basket?";
BASKETBALL_L2_PROMPTS[BASKETBALL_L2_PROMPT_INDEXES.COLOR_SECOND] = "Which color ball moved to the basket on the left?";
BASKETBALL_L2_PROMPTS[BASKETBALL_L2_PROMPT_INDEXES.COLOR_THIRD] = "Which color ball moved to the basket on the right?";
BASKETBALL_L2_PROMPTS[BASKETBALL_L2_PROMPT_INDEXES.DIRECTION_GENERIC] = "Where did the ball move?";
BASKETBALL_L2_PROMPTS[BASKETBALL_L2_PROMPT_INDEXES.BALL_FIRST] = "Which ball went into the basket?";
BASKETBALL_L2_PROMPTS[BASKETBALL_L2_PROMPT_INDEXES.BALL_SECOND] = "Which ball moved to the basket on the left?";
BASKETBALL_L2_PROMPTS[BASKETBALL_L2_PROMPT_INDEXES.BALL_THIRD] = "Which ball moved to the basket on the right?";
