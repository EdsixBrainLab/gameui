...
console.log("canvas.width ::"+canvas.width)
    ...
    call_UI_introQuestionCardContainer(container,"lube");
    ...
    introChoice4.gotoAndStop(11)
    cluegotoArr = [, 1, 11, 20, 4]
