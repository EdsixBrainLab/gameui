...
var nameArr = ["longed", "genre", "melon", "mile", "magnate", "cheap", "sore", "lube", "microns", "voile", "ant", "livers"];
var words_arry = ["golden", "green", "lemon", "lime", "magenta", "peach", "rose", "blue", "crimson", "olive", "tan", "silver"];
...
function init() {
  ...
  assetsPath = "assets/";
  gameAssetsPath = "Anagrams-Colors/";
  soundpath = "FA/";
...
loaderBar.visible = false;
  stage.update();
   ...
   call_UI_gameQuestion(container,"Find the name of a color that is an anagram of");
