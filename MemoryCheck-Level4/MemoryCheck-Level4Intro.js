...
var posX12 = [260, 520, 780, 1040]
var posY12 = [320, 320, 320, 320]
var introArr = []
var introArr1 = []
var val = [0, 2, 3, 4, 5]
var val1 = [4, 6, 0, 2]
...
function commongameintro() {
    ...
    for (i = 0; i < 5; i++) {
        ...
        introArr[i].scaleX = introArr[i].scaleY = 1.1;
...
function introCh() {
    ...
    if (introArr1[1]) {
        createjs.Tween.get(introArr1[1]).wait(600).to({ alpha: 1, scaleX: .9, scaleY: .9 }, 500)
            .to({ scaleX: 1.0, scaleY: 1.0 }, 500).to({ scaleX: .9, scaleY: .9 }, 500)
            .to({ scaleX: 1.0, scaleY: 1.0 }, 700).wait(2000).call(handleComplete7_1);
    } else {
