...
var introQuesTextX = 5, introQuesTextY = -100;
var introQuesX = 600, introQuesY = 265
var introArrowX = 450, introArrowY = 520;
var introfingureX = 490, introfingureY = 600;
...
introQuestxt = QusTxtString.clone();
    ...
    for (i = 0; i < 5; i++) {
        ...
        introChoiceQues[i].x = 370.5 + (i * 130);
        introChoiceQues[i].y = 480;
...
function QueschoiceTween() {
    ...
    for (i = 0; i < 5; i++) {
        ...
        introChoiceQues[0].gotoAndStop(0);
        introChoiceQues[1].gotoAndStop(15);
        introChoiceQues[2].gotoAndStop(15);
        introChoiceQues[3].gotoAndStop(26);
        introChoiceQues[4].gotoAndStop(4);
        if (i == 3) {
...
function choiceTween() {
    ...
    for (i = 0; i < 3; i++) {
        ...
        introchoiceArr[0].gotoAndStop(11);
...
this.onComplete2 = function (e) {
    ...
    if (stopValue == 0) {
        ...
        introChoiceQues[3].gotoAndStop(11);
