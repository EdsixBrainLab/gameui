...
var quesArr = ["ability", "abscond", "amplify", "applaud", "attempt", "beneath", "booklet", "caption", "capture", "cherish", "compact", "conceal", "concept", "crucial",
    "delight", "destiny", "despite", "enforce", "entitle", "episode", "exclude", "execute", "fashion", "fatigue", "formula", "habitat", "illegal", "insight",
    "intense", "justice", "lateral", "liberal", "magical", "magnify", "massive", "message", "visible", "oblique", "optimal", "outrage", "partial", "phantom",
    "penalty", "recruit", "rejoice", "renewal", "session", "stamina", "terrify", "thought"];
...
function init() {
    ...
    assetsPath = "assets/";
    gameAssetsPath = "MissingLetter-Level3/";
    soundpath = "FA/"
    ...
    if (success == 1) {
        manifest.push(
            ...
            { id: "QusTxtString", src: questionTextPath + "MissingLetter-Level3-QT.png" }
...
function doneLoading1(event) {
    ...
    if (id == "cluetext") {
        var spriteSheet1 = new createjs.SpriteSheet({
            ...
            "frames": { "regX": 50, "height": 113, "count": 64, "regY": 50, "width": 479 },
            // define two animations, run (loops, 1.5x speed) and jump (returns to run):
            //"frame": {"x":0,"y":0,"w":543,"h":127},
        });
...
function createTween() {
    ...
    for (i = 0; i < 7; i++) {
        ...
        createjs.Tween.get(qarr[i]).wait(500).to({ scaleX: .85, scaleY: .85, alpha: 1 }, 500)
            .to({ scaleX: .9, scaleY: .9, alpha: 1 }, createjs.Tween.bounceInOut)
    }
