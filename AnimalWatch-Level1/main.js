...
var rand
var rand1 = []
var qtxtArr = [0, 1, 0, 1, 1, 1, 0, 0, 1, 0]
///////////////////////////////////////////////////////////////////////GAME SPECIFIC ARRAY//////////////////////////////////////////////////////////////
var qno = [];
var choiceArr = [];
///////////////////////////////////////////////////////////////////
...
function init() {
    ...
    assetsPath = "assets/";
    gameAssetsPath = "AnimalWatch-Level1/";
    soundpath = "FA/"
    ...
    if (success == 1) {
        manifest.push(
            ...
            { id: "questiontext", src: questionTextPath + "AnimalWatch-Level1-QT.png" }
...
function doneLoading1(event) {
    ...
    if (id == "choice1" || id == "choice2" || id == "choice3") {
        var spriteSheet2 = new createjs.SpriteSheet({
            ...
            "frames": { "regX": 50, "height": 255, "count": 0, "regY": 50, "width": 254 },
        ...
        var spriteSheet3 = new createjs.SpriteSheet({
            ...
            "frames": { "regX": 50, "height": 256, "count": 0, "regY": 50, "width": 254 },
            // define two animations, run (loops, 1.5x speed) and jump (returns to run):
        ...
        var spriteSheet4 = new createjs.SpriteSheet({
            ...
            "frames": { "regX": 50, "height": 256, "count": 0, "regY": 50, "width": 255 },
            // define two animations, run (loops, 1.5x speed) and jump (returns to run):
    ...
    if (id == "question") {
        var spriteSheet1 = new createjs.SpriteSheet({
            ...
            "frames": { "regX": 50, "height": 400, "count": 0, "regY": 50, "width": 1014 },
            // define two animations, run (loops, 1.5x speed) and jump (returns to run):
        });
    ...
    if (id == "questiontext") {
        var spriteSheet1 = new createjs.SpriteSheet({
            ...
            "frames": { "regX": 50, "height": 73, "count": 0, "regY": 50, "width": 578 },
            // define two animations, run (loops, 1.5x speed) and jump (returns to run):
        });
...
function CreateGameElements() {
    ...
    choice1.x = 170;
    choice1.y = choice2.y = choice3.y = 330;
    choice2.x = 565;
    choice3.x = 960;
...
function showQuestion() {
    ...
    questiontext.gotoAndStop(qtxtArr[qno[cnt]] + 1)
    questiontext.visible = false
    for (i = 1; i <= choiceCnt; i++) {
