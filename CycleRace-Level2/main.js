...
var parrotWowMc, parrotOopsMc, parrotGameOverMc, parrotTimeOverMc, gameIntroAnimMc, targetMc;
...
var chPosArr3 = [1, 2, 3, 4, 1, 2, 3, 4]
var self = this
var posY = [, 372, 395, 415, 433, 465, 493, 505, 538] // Cycle Y Position
var s1 = "";
...
function init() {
	...
	assetsPath = "assets/";
	gameAssetsPath = "CycleRace-Level2/";
	soundpath = "FA/"
	...
	if (success == 1) {
		manifest.push(
			...
			{ id: "questiontext", src: questionTextPath + "CycleRace-Level2-QT1.png" },
			...
			{ id: "question2", src: questionTextPath + "CycleRace-Level2-QT2.png" },
			{ id: "choice1", src:  questionTextPath + "CycleRace-Level2-QT3.png" },
			{ id: "introHintTextMc", src: questionTextPath + "CycleRace-Level2-QT4.png" }
		)
		preloadAllAssets()
		stage.update();
	}
...
function doneLoading1(event) {
	...
	if (id == "question2") {
		var spriteSheet10 = new createjs.SpriteSheet({
			...
			"frames": { "regX": 82, "height": 63, "count": 300, "regY": 0, "width": 575 },
			// define two animations, run (loops, 1.5x speed) and jump (returns to run):
			"animations": {
				"run": [0, 16, "run", .4]
...
function pickques() {
	...
	targetMc.visible = false;
	speed_arry_1 = [2.4, 1.8, 1, 0.5];
	speed_arry = [2.4, 1.8, 1, 0.5];
