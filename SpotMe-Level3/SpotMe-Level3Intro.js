...
function commongameintro() {
    ...
    introquestion.gotoAndStop(29)
    introApplyScaleMeta(introquestion, SPOTME_INTRO_QUESTION_SCALE);
    introSetScaledXY(introquestion, 500, 365);
...
function quesTween() {
    ...
    var introQuestionTarget = introGetScaledPosition(introquestion, 500, 365);
...
function introPosChange() {
    if (stopValue == 0) {
        ...
        var thirdTarget = introGetScaledPosition(introquesArr[2], introsX[3], introsY[3]);
        ...
        createjs.Tween.get(introquesArr[3]).to({ x: fourthTarget.x, y: fourthTarget.y }, 500).wait(400).call(introPosChange1);
    }
}
function introPosChange1() {
    if (stopValue == 0) {
        ...
        createjs.Tween.get(introquesArr[0]).to({ x: firstTarget.x, y: firstTarget.y }, 500).wait(400);
        var secondTarget = introGetScaledPosition(introquesArr[3], introsX[2], introsY[2]);
        createjs.Tween.get(introquesArr[3]).to({ x: secondTarget.x, y: secondTarget.y }, 500).wait(400).call(introPosChange2);
    }
}
...
function introPosChange2() {
    if (stopValue == 0) {
        ...
        var firstTarget = introGetScaledPosition(introquesArr[0], introsX[2], introsY[2]);
        createjs.Tween.get(introquesArr[0]).to({ x: firstTarget.x, y: firstTarget.y }, 500).wait(400);
        var secondTarget = introGetScaledPosition(introquesArr[1], introsX[0], introsY[0]);
        createjs.Tween.get(introquesArr[1]).to({ x: secondTarget.x, y: secondTarget.y }, 500).wait(400);
        var thirdTarget = introGetScaledPosition(introquesArr[2], introsX[3], introsY[3]);
        createjs.Tween.get(introquesArr[2]).to({ x: thirdTarget.x, y: thirdTarget.y }, 500).wait(400);
        var fourthTarget = introGetScaledPosition(introquesArr[3], introsX[1], introsY[1]);
        createjs.Tween.get(introquesArr[3]).to({ x: fourthTarget.x, y: fourthTarget.y }, 500).wait(400).wait(2000).call(handleComplete3_1);
    }
}
