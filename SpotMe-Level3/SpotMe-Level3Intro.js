...
function quesTween() {
    ...
    createjs.Tween.get(introquestion).wait(2500).to({ y: introquestion.y, alpha: 1 }, 500).to({ y: introquestion.y + 73 }, 1000, createjs.Ease.bounceOut).wait(500).call(handleComplete2_1);
...
function introPosChange() {
    if (stopValue == 0) {
        ...
        createjs.Tween.get(introquesArr[0]).to({ x: introsX[2], y: introsY[2] }, 500).wait(400);
        createjs.Tween.get(introquesArr[1]).to({ x: introsX[1], y: introsY[1] }, 500).wait(400);
        createjs.Tween.get(introquesArr[2]).to({ x: introsX[3], y: introsY[3] }, 500).wait(400);
        createjs.Tween.get(introquesArr[3]).to({ x: introsX[0], y: introsY[0] }, 500).wait(400).call(introPosChange1);
    }
}
function introPosChange1() {
    if (stopValue == 0) {
        ...
        createjs.Tween.get(introquesArr[3]).to({ x: introsX[2], y: introsY[2] }, 500).wait(400).call(introPosChange2);
    }
}
...
function introPosChange2() {
    if (stopValue == 0) {
        ...
        createjs.Tween.get(introquesArr[2]).to({ x: introsX[3], y: introsY[3] }, 500).wait(400);
        createjs.Tween.get(introquesArr[3]).to({ x: introsX[1], y: introsY[1] }, 500).wait(400).wait(2000).call(handleComplete3_1);
    }
}
