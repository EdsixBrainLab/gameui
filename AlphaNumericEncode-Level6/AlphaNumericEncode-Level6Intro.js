...
var introfingureX = 520, introfingureY = 410;
var introArr = []
...
var introArr1 = []
var val
var posX = [140, 520, 900, 313, 727, 313, 727]
...
function choiceTween() {
    ...
    if (stopValue == 0) {
        ...
        createjs.Tween.get(introChoiceArr[5]).wait(1200).to({ x: introChoiceArr[5].x, y: 620, alpha: 0 }, 500).to({ x: introChoiceArr[5].x, y: 610, alpha: 0.5 }, 500).to({ x: introChoiceArr[5].x, y: 610, alpha: 1 })
        createjs.Tween.get(introChoiceArr[6]).wait(1400).to({ x: introChoiceArr[6].x, y: 620, alpha: 0 }, 500).to({ x: introChoiceArr[6].x, y: 620, alpha: 0.5 }, 500).to({ x: introChoiceArr[6].x, y: 610, alpha: 1 }).call(handleComplete3_1);
...
function introCh() {
    introImg.y = 360
    createjs.Tween.get(introImg).to({ visible: true }).to({ alpha: 0 }).to({ alpha: 1, y: 100 }, 500).wait(3500).call(handleComplete5_1);
}
