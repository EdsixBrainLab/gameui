...
var chPosArr3 = [1, 2, 3, 4, 5]
var self = this
var posY = [, 380, 405, 425, 445, 465, 485, 515, 530] // Cycle Y Position
var s1 = "";
...
function init() {
	...
	assetsPath = "assets/";
	gameAssetsPath = "CycleRace-Level3/";
	soundpath = "FA/"
	...
	if (success == 1) {
		manifest.push(
			...
			{ id: "questiontext", src: questionTextPath + "CycleRace-Level3-QT1.png" },
			...
			{ id: "question2", src: questionTextPath + "CycleRace-Level3-QT2.png" },
			{ id: "choice1", src: questionTextPath + "CycleRace-Level3-QT3.png" },
			{ id: "introHintTextMc", src: questionTextPath + "CycleRace-Level3-QT4.png" }
		)
		preloadAllAssets()
		stage.update();
	}
...
function pickques() {
	...
	targetMc.visible = false;
	speed_arry_1 = [1.8, 1.6, 1.2, .9, 0.5];

	speed_arry = [1.8, 1.6, 1.2, .9, 0.5];
