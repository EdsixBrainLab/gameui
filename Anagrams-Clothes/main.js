...
var nameArr = ["lips", "saint", "scale", "based", "repaid", "stop", "super", "boost", "sober", "hose", "coast", "parson", "hirst", "sderd", "kirts", "jtcaek", "shtros", "tewsrat", "ath", "vogles", "fcrsa", "tleb", "hseos", "snaej", "tsaeertw", "vgloe", "shttrii", "tves", "tsoob", "csok", "svet", "rejupm", "orbe", "pca", "ckos", "vleopur", "laselrov", "eovsgl", "swahl", "tusi", "ntsimet", "twseera", "artncoai", "chonpo", "sndalas", "pajamsa", "rdgacina", "egnrsdaue", "eodhio", "sgihht", "lrpssepi", "oinmko", "frsca", "swtreat", "rbdumea", "ctekja", "trssho"];
var words_arry = ["slip", "satin", "laces", "beads", "diaper", "tops", "purse", "boots", "robes", "shoe", "coats", "aprons", "shirt", "dress", "skirt", "jacket", "shorts", "sweater", "hat", "gloves", "scarf", "belt", "shoes", "jeans", "sweater", "glove", "t-shirt", "vest", "boots", "socks", "vest", "jumper", "robe", "cap", "sock", "pullover", "overalls", "gloves", "shawl", "suit", "mittens", "sweater", "raincoat", "poncho", "sandals", "pajamas", "cardigan", "dungarees", "hoodie", "tights", "slippers", "kimono", "scarf", "sweater", "bermuda", "jacket", "shorts"];
...
function init() {
  ...
  assetsPath = "assets/";
  gameAssetsPath = "Anagrams-Clothes/";
  soundpath = "FA/";
...
loaderBar.visible = false;
  stage.update();
   ...
   call_UI_gameQuestion(container,"Find the name of something related to clothing that is an anagram of");
