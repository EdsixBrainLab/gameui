...
var nameArr = ["tacit", "boredom", "stage", "slight", "palms", "thicken", "stable", "flesh", "tops", "petal", "danger", "sitars", "adobe", "redraw", "votes", "but", "moor", "odor", "hissed", "spectra", "stink", "snap", "stud", "wolf", "skin", "potate", "blow", "bleat", "save", "hurbs", "these"];
var words_arry = ["attic", "bedroom", "gates", "lights", "lamps", "kitchen", "tables", "shelf", "pots", "plate", "garden", "stairs", "abode", "drawer", "stove", "tub", "room", "door", "dishes", "carpets", "knits", "pans", "dust", "flow", "sink", "teapot", "bowl", "table", "vase", "brush", "sheet"];
...
function init() {
  ...
  assetsPath = "assets/";
  gameAssetsPath = "Anagrams-HouseHold/";
  soundpath = "FA/";
...
loaderBar.visible = false;
  stage.update();
   ...
   call_UI_gameQuestion(container,"Find the name of something that is seen at home that is an anagram of");
