...
var introQuesX = 565, introQuesY =180
var introArrowX = 768, introArrowY = 500;
var introfingureX =815, introfingureY = 580;
...
//////////////////////////////////////////////////////////////////////////
 ...
 for (i = 0; i < 5; i++) {
        ...
        introChoiceQues[i].x =395 + (i * 120);
        introChoiceQues[i].y = 435;
...
function QueschoiceTween() { 
 ...
 for (i = 0; i <5; i++) {
        ...
        introChoiceQues[0].gotoAndStop(14);
        introChoiceQues[1].gotoAndStop(13);
        introChoiceQues[2].gotoAndStop(8);
        introChoiceQues[3].gotoAndStop(14);
        introChoiceQues[4].gotoAndStop(26);     
...
var val =500
  for (i = 0; i < 3; i++) {
        introchoiceArr[i].visible = true;   
         ...
         introchoiceArr[0].gotoAndStop(i+15);
     introchoiceArr[i].gotoAndStop(i+14);
        introchoiceArr[2].gotoAndStop(13);
...
this.onComplete2 = function (e) {
    ...
    introChoiceQues[4].visible = true             
        introChoiceQues[4].gotoAndStop(13);     
        createjs.Tween.get(introChoiceQues[4])  
