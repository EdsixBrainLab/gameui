...
var introQuesX = 210, introQuesY = 200;
var introArr = []
...
var posY = []
var introArrowX = 534, introArrowY = 275;
...
function commongameintro() {
    ...
    introChoice2.x = 685; introChoice2.y = 280;
    introChoice3.x = 900; introChoice3.y = 480;
    posY = [, 480, 280, 480]
...
function quesTween() {
    ...
    introQues.x = 1000;
    createjs.Tween.get(introQues).to({  x: 70,y:51 }, 500, createjs.Ease.bounceOut).wait(4000).call(handleComplete2_1)
...
function choiceTween() {
    ...
    for (i = 1; i <= 3; i++) {
        ...
        if (i == 3) {
            createjs.Tween.get(this["introChoice" + i]).wait(temp1).to({ y: 360 }, 1000, createjs.Ease.bounceOut).wait(300).call(handleComplete5_1);

        }
        else {
            createjs.Tween.get(this["introChoice" + i]).wait(temp1).to({ y: 360 }, 1000, createjs.Ease.bounceOut)
