...
var words_arry = ["but", "could", "does", "from", "fast", "may", "once", "take", "was", "who", "run", "draw", "clean", "never"]
var nameArr = ["tub", "cloud", "dose", "form", "fats", "yam", "cone", "teak", "saw", "how", "urn", "ward", "lance", "nerve"]
...
function init() {
  ...
  assetsPath = "assets/";
  gameAssetsPath = "Anagrams-DolchWords/";
  soundpath = "FA/";
...
loaderBar.visible = false;
  stage.update();
   ...
   call_UI_gameQuestion(container,"Find the Dolchword that is an anagram of");
