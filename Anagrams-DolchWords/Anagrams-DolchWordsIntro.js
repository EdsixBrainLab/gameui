...
console.log("canvas.width ::"+canvas.width)
    ...
    call_UI_introQuestionCardContainer(container,"form");
    ...
    introChoice4.gotoAndStop(17)
    cluegotoArr = [, 5, 17, 14, 12]
