...
var words_arry = ["circle", "octagon", "pentagon", "square", "rectangle", "triangle", "semicircle", "oval", "cylinder", "hexagon"];
var maxLetterCnt = 10
var quesArr = []
...
function doneLoading1(event) {
    ...
    stage.update();
	call_UI_gameQuestion(container,"Click on the correct letter to complete the name of the shape");
    if (id == "question") {
        var choiceSpriteSheet = new createjs.SpriteSheet({
            framerate: 30,
            "images": [preload.getResult("question")],
            "frames": { "regX": 50, "height": 299, "count": 64, "regY": 50, "width": 298 },
