...
var introArrowX = 790, introArrowY = 260;
var introfingureX = 810, introfingureY = 440;
var posX11 =  [65, 515, 965, 65, 515, 965]
var posY11 = [190, 190, 190, 460, 460, 460]
var posX12 = [530,980,755,530,980]
var posY12 = [230,230,375,520,520]
var introArr = []
var introArr1 = []
var val = [0,2,3,4,5,6]
var val1 = [4,0,7,2,3]
...
var temp1 = 100
    for (i = 0; i < 6; i++) {
        ...
        if(i==5){
            createjs.Tween.get(introArr[i]).wait(temp1).to({ alpha: 0 }, 500).to({ alpha: 1 }).wait(3000).call(handleComplete2_1);
...
function choiceTween() {
    ...
    for (i = 0; i < 5; i++) {
        ...
        introArr1[i].__targetY = introArr1[i].__targetY || introArr1[i].y;
...
function introCh() {
    ...
    createjs.Tween.get(introArr1[2]).wait(600).to({ alpha: 1, scaleX: .65, scaleY:.65 }, 500)
