...
var introQuesX = 425, introQuesY = 280;
...
var introArr1 = []
var val
var posX = [190, 770, 190, 770]
var posY = [330, 330, 555, 555]


var posX1 = [180, 455, 764, 1042]
    ...
    for (i = 0; i < 4; i++) {
        if (stopValue == 0) {
            ...
            if (i == 3) {
                ...
                createjs.Tween.get(introArr1[i]).wait(temp1).to({ alpha: 0 }, 500).to({ alpha: 1 }, 500).wait(3000).call(handleComplete2_1);
...
function introCh(){
    introImg.y = 360
    createjs.Tween.get(introImg).to({ visible : true }).to({ alpha : 0 }).to({alpha : 1 , y : 130 }, 500).wait(3500).call(handleComplete5_1);
}
