...
var words_arry = ["car", "rocket", "helicopter", "ship", "jeep", "bus", "train", "bicycle", "aeroplane", "bike",
                    "ambulance", "truck", "taxi", "fireengine", "crane", "dumptruck", "carriage", "scooter", "tractor", "boat"];
var maxLetterCnt = 10
var quesArr = []
...
function init() {
    ...
    assetsPath = "assets/";
    gameAssetsPath = "WhoAmI-Transport/";
    soundpath = "FA/"
...
function doneLoading1(event) {
    ...
    stage.update();
	call_UI_gameQuestion(container,"Click on the correct letter to complete the name of the transport");
    if (id == "question") {
