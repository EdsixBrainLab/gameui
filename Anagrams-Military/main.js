...
var words_arry = ["battle", "kills", "missile", "shot", "shoot", "war", "squad", "plane", "rescue", "defeats", "soldier", "general", "cadet", "camps", "corps"]
var nameArr = ["tablet", "skill", "similes", "host", "hoots", "raw", "quads", "panel", "secure", "deafest", "solider", "enlarge", "acted", "scamp", "crops"]
...
function init() {
  ...
  assetsPath = "assets/";
  gameAssetsPath = "Anagrams-Military/";
  soundpath = "FA/";
...
loaderBar.visible = false;
  stage.update();
   ...
   call_UI_gameQuestion(container,"Find a term related to the military that is an anagram of");
