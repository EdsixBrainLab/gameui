...
var introQuesX = 616, introQuesY =250
var introArrowX = 450, introArrowY = 520;
var introfingureX = 469, introfingureY = 600;
...
function quesTween() {
    ...
    createjs.Tween.get(introQues).wait(800)
     .to({ y:270,scaleX:.75,scaleY :.75,alpha: 1 }, 500)
        .to({ y:270,scaleX:.8,scaleY :.8,alpha: 1 }, 1000)
