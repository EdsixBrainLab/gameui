...
function pickques() {
    ...
    for (i = 0; i < 4; i++) {
        ...
        choiceArr[i].baseScale = 1.05;
        choiceArr[i].scaleX = choiceArr[i].scaleY = choiceArr[i].baseScale;
    }
    animatePreviewTiles(choiceArr, btnx, btny, function () {
...
function createChoices() {
    ...
    chpos = between(0, 3);
    var answerPosX = [220, 820, 220, 820];
    var answerPosY = [170, 170, 440, 440];
    for (i = 0; i < 4; i++) {
        ...
        tile.x = answerPosX[i];
        tile.y = answerPosY[i];
        tile.__targetX = answerPosX[i];
        tile.__targetY = answerPosY[i];
        tile.baseScale = tile.baseScale || 0.95;
...
function enablechoices() {
    for (i = 0; i < 4; i++) {
        ...
        choiceArr1[i].mouseEnabled = false;
        choiceArr1[i].cursor = "default";
        choiceArr1[i].baseScale = choiceArr1[i].baseScale || 0.95;
