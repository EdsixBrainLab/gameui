...
var introQuesX = 610, introQuesY =290
var introArrowX = 450, introArrowY = 520;
var introfingureX = 480, introfingureY = 610;
...
function QueschoiceTween() { 
 ...
 for (i = 0; i <4; i++) {
        ...
        introChoiceQues[0].gotoAndStop(6);
...
var val =500
  for (i = 0; i < 3; i++) {
        ...
        introchoiceArr[0].gotoAndStop(19);
...
this.onComplete2 = function (e) {
    ...
    if (stopValue == 0) {
        ...
        introChoiceQues[3].gotoAndStop(19);     
