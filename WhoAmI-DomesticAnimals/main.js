...
var words_arry = ["cat", "goat", "cow", "dog", "donkey", "horse", "rabbit", "sheep", "calf", "squirrel"];
var maxLetterCnt = 10
var quesArr = []
...
function init() {
    ...
    assetsPath = "assets/";
    gameAssetsPath = "WhoAmI-DomesticAnimals/";
    soundpath = "FA/"
...
function doneLoading1(event) {
    ...
    stage.update();
	call_UI_gameQuestion(container,"Click on the correct letter to complete the name of the domestic animal");
    if (id == "question") {
        var choiceSpriteSheet = new createjs.SpriteSheet({
            framerate: 30,
            "images": [preload.getResult("question")],
            "frames": { "regX": 50, "height": 285, "count": 64, "regY": 50, "width": 286 },
