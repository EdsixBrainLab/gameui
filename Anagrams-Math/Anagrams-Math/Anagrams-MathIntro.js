...
var introClu1X = 445, introClu1Y = 415;
var introClu2X = 565, introClu2Y = 415;
var introClu3X = 685, introClu3Y = 415;
var introClu4X = 805, introClu4Y = 415;
var introArrowX = 210, introArrowY = 350;
var introfingureX = 220, introfingureY = 520;
var ArrowXArr = [, 503, 943, 723, 283],FingXArr = [, 525, 965, 745, 305]
...
function commongameintro() {
    ...
    introQues1 = new createjs.Text("once", "60px lato-Bold", "#2f8c62");
    ...
    introChoice4.gotoAndStop(14)
    cluegotoArr = [, 2, 14, 13, 4]
...
function choiceTween() {
    ...
    for (i = 1; i < 5; i++) {
        ...
        if (i == 4) {
            createjs.Tween.get(this["introChoice" + i]).wait(val).to({ y: 570, scaleX: .8, scaleY: .8, alpha: 1 }, val).call(handleComplete4_1);
        }
        else {
            createjs.Tween.get(this["introChoice" + i]).wait(val).to({ y: 570, scaleX: .8, scaleY: .8, alpha: 1 }, val);
        }
