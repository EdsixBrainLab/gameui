...
var words_arry = ["cloud", "heat", "rain", "iced", "sunrise", "frost", "sleet", "snow", "thaw", "snowed", "dew", "overcast"]
var nameArr = ["could", "hate", "iran", "dice", "insures", "forts", "steel", "owns", "what", "endows", "wed", "overacts"]
...
function init() {
  ...
  assetsPath = "assets/";
  gameAssetsPath = "Anagrams-Weather/";
  soundpath = "FA/";
...
loaderBar.visible = false;
  stage.update();
   ...
   call_UI_gameQuestion(container,"Find the word related to weather that is an anagram of");
