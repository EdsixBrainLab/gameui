var introQues1, introQuestxt, introChoice1, introChoice2, introChoice3, introDummyHolder, introDummyHolder1, introHolder, introArrow, introfingure, introTitle;
...
var choiceXArr = [320, 540, 760]

var choiceXArr1 = [540, 760, 320]
var choiceYArr = [345, 345, 345]
var chGotoArr = [8, 23, 17]
var chGotoArr1 = [17, 8, 23]
...
function commongameintro() {
    ...
    for (i = 0; i < 3; i++) {
        ...
        introPosArr[i].x = choiceXArr1[i] + 103;
...
function choiceTweenB() {
    ...
    createjs.Tween.get(introDummyHolder).wait(500).to({ x: 260, y: 127, scaleX: .65, scaleY: .65 }, 1000).call(handleComplete4_11);
