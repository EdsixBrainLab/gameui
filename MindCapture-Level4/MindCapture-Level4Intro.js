...
var introChoiceX = [, 190, 600, 1005, 397, 802]
var introArrowX = 663, introArrowY = 525;
var introfingureX = 700, introfingureY = 607;
var introquestionX = 990; introquestionY = -240;
var introquestionTextX = 310, introquestionTextY = 130
var introyesx = 660, introyesy = 650;
var intronox = 1020; intronoy = 650;
...
function commongameintro() {
    ...
    for (i = 1; i <= 5; i++) {
        ...
        introquesArr[i].scaleX = introquesArr[i].scaleY = .95
        if (i <= 3) {
            introquesArr[i].y = 200
            introquesArr[i].gotoAndStop(5 + i);
        }
        else {
            introquesArr[i].y = 430
            introquesArr[i].gotoAndStop(i - 2);
        }
...
function choiceTween() {
    var introvalX = [, 430, 500, 580, 650, 720]
...
function choiceTween1() {
    ...
    createjs.Tween.get(introHintImg).wait(3000).to({ scaleX: .6, scaleY: .6, x: 50, y: 220 }, 500).wait(500).call(handleComplete4_1);
