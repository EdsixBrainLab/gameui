...
function init() {
    ...
    assetsPath = "assets/";
    gameAssetsPath = "SequenceMemory-Level4/";
    soundpath = "FA/"
    ...
    if (success == 1) {
        manifest.push(
            ...
            { id: "questiontext", src: questionTextPath + "SequenceMemory-Level4-QT.png" }
        )
        preloadAllAssets()
        stage.update();
    }
...
function delayStartQuestion() {
    ...
    var chpos1 = between(0, 5)
    var shuffle = between(0, 5)
    var j;
