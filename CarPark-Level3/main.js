...
function init() {
    ...
    if (success == 1) {
        manifest.push(
            ...
            { id: "choice1", src: gameAssetsPath + "CarQuestionImage.png" }, { id: "holder", src: gameAssetsPath + "CarIntroHolder.png" }, { id: "DirPosTrack", src: questionTextPath + "CarPark-Level3-QT5.png" }, { id: "DirPosArrow", src: gameAssetsPath + "ClueDirPosArrow.png" }, { id: "questionText", src: questionTextPath + "CarPark-Level3-QT1.png" }, { id: "car", src: questionTextPath + "CarPark-Level3-QT2.png" }, { id: "Buttons", src: gameAssetsPath + "question.png" }, { id: "question1", src: questionTextPath + "CarPark-Level3-QT4.png" }, { id: "DirPosCar", src: gameAssetsPath + "ClueDirPosCar.png" }, { id: "DirPosQuestionText", src: questionTextPath + "CarPark-Level3-QT3.png" }
