var introQues, introTitle,introQuestxt, introArrow, introfingure, introHolder;
var introChoiceQues=[]
var introchoiceArr=[]
...
var introQuesTextX =5, introQuesTextY = -10;
var introQuesX = 599, introQuesY =258
var introArrowX = 450, introArrowY = 509;
var introfingureX = 494, introfingureY = 600;
function commongameintro() {
    ...
    introQues.gotoAndStop(7);
	
     introArrow = arrow1.clone();
	introHolder = holder1.clone()
...
//////////////////////////////////////////////////////////////////////////
    ...
    for (i = 0; i < 4; i++) {
        ...
        introChoiceQues[i].x =454 + (i * 120);
        introChoiceQues[i].y = 478;
...
////////////////////////////////////////////////////////////////////////////////////
    ...
    createjs.Tween.get(introQuestxt).to({visible:true,alpha: 1 }, 1000,createjs.Ease.bounceInOut)
...
function quesTween() {
  ...
  //  createjs.Tween.get(introHolder).to({ x: 0, alpha: 1 }, 500);
    ...
    introQues.regX=50;
    introQues.regY=50;
    createjs.Tween.get(introQues).wait(800)
     .to({ scaleX:.75,scaleY :.75,alpha: 1 }, 500)
        .to({ scaleX:.8,scaleY :.8,alpha: 1 }, 1000)
...
function QueschoiceTween() { 
 ...
 for (i = 0; i <4; i++) {
        ...
        introChoiceQues[1].gotoAndStop(11);
        introChoiceQues[2].gotoAndStop(20);
...
var val =500
  for (i = 0; i < 3; i++) {
        ...
        introchoiceArr[0].gotoAndStop(4);
        introchoiceArr[i].scaleX=introchoiceArr.scaleY=.65
        if(i==2)
{
         createjs.Tween.get(introchoiceArr[i]).wait(val).to({ y: 600,rotation:180, scaleX: .65, scaleY: .65, alpha: .5 }, 200)
        .to({ y: 600,rotation:360, scaleX: .7, scaleY: .7, alpha: 1 }, 200)
