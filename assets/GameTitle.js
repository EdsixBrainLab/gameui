var titleArr = ['AddGuru', 'AddMaster', 'AlienSmiley', 'AlphabetTrain', 'AlphaNumberRead', 'AlphaNumericEncode', 'Anagrams', 'Anagrams', 'Anagrams', 'Anagrams', 'Anagrams', 'Anagrams',
    ...
    'PicturePreposition', 'Planets', 'PrefixRootAndSuffix', 'CompassConnect', 'RearMagic', 'Rebus', 'ReflectionRead', 'RememberMyName', 'Reshuffle', 'ReverseReading', 'RootWords', 'RouteMemory', 'Senses', 'SequenceGrid', 'SequenceMemory',
    ...
    'Angles', 'BotanicalName', 'Calculate', 'CompleteTheShape', 'CountMe', 'CountMyHand', 'DigitalAlphaCount', 'DigitalSegment', 'DigitalWord',
    'DivideTheWheel', 'DragTheShapes', 'FindMyHalf', 'FindNext', 'FindTheFreak', 'FindThePair', 'FindTheSame', 'FindTheSamePattern', 'FruitColor',
    'GeometricShapes', 'GiftBox', 'HiddenObjects', 'IconSmiley', 'LetterSeries', 'LetterWeb', 'MissingColor', 'MissingPair',
    'NamesOfSymbols', 'NumberAnalogy', 'NumberBurst', 'ObjectColor', 'Opposites', 'Punching', 'ShapeDimension', 'ShapeRace', 'Alphabets', "SpellingRecognition", "ObjectRecognition", 'WordRecognition'];
...
function createTitleBtn() {
    ...
    } else if (titleValue > 199 && titleValue < 300) {

        TitleBtn = TitleBtn3.clone();

    } else if (titleValue > 299 && titleValue < 400) {

        TitleBtn = TitleBtn4.clone();
